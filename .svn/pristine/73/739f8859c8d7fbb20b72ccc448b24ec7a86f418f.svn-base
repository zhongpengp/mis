			...
			if(user!=null){
				if("2".equals(user.getUserStatue())){
					...
					if("1".equals(user.getUserType())){
						...
						if(project!=null&&project.getProjectStatue()!=null&&!project.getProjectStatue().equals("4")){
							loginSuccess = true;
						}else{
							loginSuccess = false;
						...
						if(supplier!=null&&supplier.getSupplierState()!=null&&!supplier.getSupplierState().equals("3")){
							loginSuccess = true;
						}else{
							loginSuccess = false;
