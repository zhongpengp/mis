...
<title>注册审批——公司</title>
<style type="text/css">
	registerList_gs_searchForm .form-group{
		margin-bottom: 1px;
	}
	registerList_gs_searchForm .form-group label{
		margin-left:15px;
	}
</style>
<script type="text/javascript">
	$(function(){
		initTable_registerList_gs();
	...
	function initTable_registerList_gs(){
		$("#registerList_gs").bootstrapTable("destroy");
		$("#registerList_gs").bootstrapTable({
	        ...
	        queryParams:$("#registerList_gs_searchForm").serialize(),
			...
			columns : [
				...
				{field : 'applyGsUserDesc',title:'公司简介',visible : false},
	...
	<div class="container" style="margin: 0 0 0 0 ;width: 100%;">
					...
					<div id="main" class="drmtable">
						...
						<div id="filter">
							<div class="filtrate_box clearfix" style="margin-bottom: 0">
								<form id="registerList_gs_searchForm" class="form-horizontal" role="form">
								      		...
								      		<div class="form-group">
											    ...
											    <div class="checkbox col-md-2" >
													<label style="padding-left: 0px;margin-left: 0px;">
													  <input type="checkbox" id="ifPrecise" name="companyName_jingque" value="1"> 精确查询
													</label>
												</div>
												<div class="col-sm-5" align="center">
													<button id="registerList_gs_searchFormQueryReset" type="button" class="btn btn-warning">重置</button>
													<button id="registerList_gs_searchFormQuery" type="button" class="btn btn-info" onclick="initTable_registerList_gs()">查询</button>
												</div>
											 </div>
							      		</li>
									</ul>
		...
		<div class="row" style="margin-top: 3px">
			<div class="col-sm-12" style="width: 100%">
				...
				<table id="registerList_gs" class="table table-condensed" data-toolbar="#toolbar"data-toggle="table" data-striped="true" data-search="true"  data-show-columns="true">
