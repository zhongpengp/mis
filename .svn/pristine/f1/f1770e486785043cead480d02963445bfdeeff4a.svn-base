...
<script type="text/javascript">
	...
	function initprojectMsgList(param){
		...
		$("#tableD").bootstrapTable({
			...
			columns : [
						{field : 'sendProjectName', title : '发件人', align: 'left'},
						{field : 'recevieProjectName', title : '收件人', align: 'left'},
						{field : 'messageTheme', title : '消息主题', align: 'left'},
					  	{field : 'sendTime', title : '发件时间', align: 'center'},
					  	{field : 'isRead', title : '是否阅读', align: 'center',
				  		...
				  		{field : 'messageTheme', title : '操作', align: 'center',
					  		formatter: function(value,row,index){
					  			var str = "<a href='javascript:void(0)' onclick=chakanMessageDetail('"+index+"','send'); >查看</a>&nbsp;&nbsp;";
					  			return str;
					  		}
					  	}
					   ]
		...
		$("#tableDRec").bootstrapTable({
			...
			columns : [
						...
						{field : 'messageTheme', title : '消息主题', align: 'left'},
				  		...
				  		{field : 'messageTheme', title : '操作', align: 'center',
					  		formatter: function(value,row,index){
					  			var str = "<a href='javascript:void(0)' onclick=chakanMessageDetail('"+index+"','rec');>查看</a>&nbsp;&nbsp;";
	...
	function RecevieMessage(msgId){
		...
		$.ajax({
	          url :'<%=path%>/message/updateMsgRead.do',
