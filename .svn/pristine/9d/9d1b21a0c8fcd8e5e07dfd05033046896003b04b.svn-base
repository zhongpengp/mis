...
//	public void newMachineUpload(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws IOException {
//		MultipartHttpServletRequest multipartRequest = (MultipartHttpServletRequest) request;
//		// 得到上传的文件
//		String filePath = fileUploadService.returnFilePath(multipartRequest.getFile("file"), request);
//		ArrayList<String[]> data = readExcelService.readExcel(filePath, 8);
//		String applyID = request.getParameter("appID");
//		ArrayList<String[]> message = new ArrayList<String[]>();
//		message = tableTotalService.applyMachineInfo(data, applyID);
//		response.getWriter().write(JSON.toJSONString(message));
//	}
//	
//}
