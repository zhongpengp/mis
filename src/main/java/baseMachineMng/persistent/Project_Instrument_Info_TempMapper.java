...
public interface Project_Instrument_Info_TempMapper {
	...
	List<ImportProjectMachineInfo_gsReturnVO> getImportedProjectMachineInfo_gs(String companyID);

	void toPassApprovalApply(List<String> list);

	void toNotPassApprovalApply(List<String> list);

	void toResetApprovalApply(List<String> list);
}