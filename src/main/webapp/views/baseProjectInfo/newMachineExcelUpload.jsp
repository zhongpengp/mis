				...
				<div id="excelPanel">
					<div class="panel panel-primary" style="margin-bottom: 0">
						<div class="panel-heading">
							<h3 class="panel-title" align="center">设备申请信息导入</h3>
						</div>
						<div class="panel-body" align="center" >
							...
							<form name="excelImportForm" id="excelImportForm" method="post" action="<%=path%>/excelController/newMachineUpload"  enctype="multipart/form-data" target="hiddenIFrame"">   
									<label class="control-label">请选择填好数据的<font color="red">模版文件</font></label>
									<a href="<%=path%>/resource/newMachineApplyExcel.xlsx" download="">(模板文件下载)</a><br/><br/>
									<input type="hidden" name="appID" id ="appInfoID">
